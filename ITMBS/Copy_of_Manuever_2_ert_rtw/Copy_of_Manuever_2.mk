###########################################################################
## Makefile generated for component 'Copy_of_Manuever_2'. 
## 
## Makefile     : Copy_of_Manuever_2.mk
## Generated on : Thu Jun 27 15:51:26 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Copy_of_Manuever_2
...
PRODUCT_NAME              = Copy_of_Manuever_2
MAKEFILE                  = Copy_of_Manuever_2.mk
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Copy_of_Manuever_2
...
INCLUDES_BUILDINFO = -I$(START_DIR) -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2023b/toolbox/target/SUPPOR~1/ev3/include -I$(START_DIR)/Copy_of_Manuever_2_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(EV3_LMSTYPES_DIR)/.. -I$(EV3_LMS2012_DIR)/.. -I$(EV3_BYTECODES_DIR)/.. -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -I$(MATLAB_ROOT)/toolbox/target/codertarget/rtos/inc -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2023b/toolbox/target/SUPPOR~1/ev3/src
...
DEFINES_STANDARD = -DMODEL=Copy_of_Manuever_2 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = Copy_of_Manuever_2.o Copy_of_Manuever_2_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o linuxinitialize.o driver_ev3_button.o driver_ev3_lcd.o MW_legoev3init.o driver_pixy2_vision_sensor.o driver_ev3_motor.o driver_ev3_touch_sensor.o
...
%.o : $(START_DIR)/Copy_of_Manuever_2_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Copy_of_Manuever_2_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/Copy_of_Manuever_2_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Copy_of_Manuever_2.o : $(START_DIR)/Copy_of_Manuever_2_ert_rtw/Copy_of_Manuever_2.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Copy_of_Manuever_2_data.o : $(START_DIR)/Copy_of_Manuever_2_ert_rtw/Copy_of_Manuever_2_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/Copy_of_Manuever_2_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/Copy_of_Manuever_2_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/Copy_of_Manuever_2_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
