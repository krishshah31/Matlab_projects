###########################################################################
## Makefile generated for component 'Copy_of_Assignment_lego'. 
## 
## Makefile     : Copy_of_Assignment_lego.mk
## Generated on : Thu Jun 20 14:14:15 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Copy_of_Assignment_lego
...
PRODUCT_NAME              = Copy_of_Assignment_lego
MAKEFILE                  = Copy_of_Assignment_lego.mk
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Copy_of_Assignment_lego
...
DEFINES_STANDARD = -DMODEL=Copy_of_Assignment_lego -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = Copy_of_Assignment_lego.o Copy_of_Assignment_lego_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o linuxinitialize.o driver_ev3_button.o driver_ev3_lcd.o MW_legoev3init.o driver_pixy2_vision_sensor.o driver_ev3_motor.o driver_ev3_touch_sensor.o
...
%.o : $(START_DIR)/Copy_of_Assignment_lego_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Copy_of_Assignment_lego_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/Copy_of_Assignment_lego_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Copy_of_Assignment_lego.o : $(START_DIR)/Copy_of_Assignment_lego_ert_rtw/Copy_of_Assignment_lego.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Copy_of_Assignment_lego_data.o : $(START_DIR)/Copy_of_Assignment_lego_ert_rtw/Copy_of_Assignment_lego_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/Copy_of_Assignment_lego_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/Copy_of_Assignment_lego_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/Copy_of_Assignment_lego_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
